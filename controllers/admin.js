...
//get add houserental page

exports.getAddHouse = (req, res, next) => {
    res.render('admin/addhouse', { msg: "", err: "" });
}

//add new houserental info
    ...
    new formidable.IncomingForm().parse(req)
        ...
        .on('fileBegin', function (name, file) {
            ...
            if (fileType == 'jpg' || fileType == 'png' || fileType == 'jpeg') {
                ...
                wrong = 1;
                res.render('admin/addhouse', { msg: "", err: "Wrong File type" });
            }
        })
        .on('aborted', () => {
            ...
            if (wrong == 1) {
                ...
                connectDB.query(data, (err, result) => {
                    ...
                    if (err) {
                        ...
                        res.render('admin/addhouse', { msg: "Data Insert Successfuly", err: "" });
                    }
                });
            }
        })
